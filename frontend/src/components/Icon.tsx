...
export const Icon: React.FC<IconProps> = ({ name, size = 16, className = "", ...props }) => {
  ...
  const paths: Record<IconName, React.ReactNode> = {
    ...
    spinner: <><path d="M21 12a9 9 0 11-6.22-8.56" /></>,
    ...
    id: <><rect x="2" y="5" width="20" height="14" rx="2" /><circle cx="8" cy="12" r="2.5" /><line x1="13" y1="10" x2="19" y2="10" /><line x1="13" y1="14" x2="17" y2="14" /></>,
